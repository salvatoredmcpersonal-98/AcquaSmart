...
import { DollarSign, Droplets, Thermometer, TestTube2, GripVertical } from 'lucide-react';
  ...
  return (
    <div className={commonClasses}>
      ...
      {onClick ? (
        ...
        <div className="w-full h-full p-3 lg:p-4 flex flex-col text-left justify-between">
          <div className="flex items-center gap-2 lg:gap-3">
            <div className={`w-8 h-8 lg:w-10 lg:h-10 rounded-full flex items-center justify-center ${colorClass}`}>
              {icon}
            </div>
